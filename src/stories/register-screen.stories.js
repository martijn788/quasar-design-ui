...
export default {
  ...
  argTypes: {
    ...
    emailLabel: { control: 'text', description: 'Label of the password input' },
...
const Template = (args, { argTypes }) => ({
  ...
  template: '<register-screen v-bind="$props" v-on="$listeners" />'
})
